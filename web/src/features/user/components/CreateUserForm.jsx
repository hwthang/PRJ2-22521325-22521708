...
const POSITION = {
  ...
  uv: { label: "Ủy viên", color: "bg-fuchsia-200 text-fuchsia-800" },
  dv: { label: "Đoàn viên", color: "bg-fuchsia-200 text-fuchsia-800" },
};
    ...
    <div className="relative">
      <div className="grid grid-cols-6 gap-x-6 gap-4 auto-rows-10 p-4">
        ...
        <div className="relative flex flex-col gap-1 col-span-6 md:col-span-3">
          ...
          <div className="grid grid-cols-2 bg-gray-200 h-10 overflow-hidden">
            {ROLE.role.map((item) => (
              <button
                key={item}
                type="button"
        ...
        <div className="relative flex flex-col gap-1 col-span-6 md:col-span-3">
          ...
          <div className="grid grid-cols-3 bg-gray-200 h-10 overflow-hidden">
        ...
        <div className="relative flex flex-col gap-1 col-span-6 md:col-span-1">
          ...
          <input
            className="border border-gray-300 py-2 px-2 border-2 focus:border-blue-400 outline-none h-10"
        ...
        <div className="relative flex flex-col gap-1 col-span-2 col-start-3 mt-2 flex justify-center items-center">
          <button
            className="h-10 md:w-1/2 w-full bg-blue-600 hover:bg-blue-500 active:bg-blue-400 text-white font-semibold"
